...
export default function HeroBanner() {
  return (
    <section className="relative w-full overflow-hidden bg-[#f5ecdf]">
      <div className="site-shell relative min-h-[620px] px-[var(--site-gutter)] sm:min-h-[680px] lg:h-[clamp(700px,64vw,900px)] lg:min-h-0">
        <Image
        ...
        <div className="relative z-10 grid h-full grid-cols-1 lg:grid-cols-[minmax(420px,0.9fr)_1.1fr]">
            ...
            <div className="flex max-w-[640px] flex-col gap-8 rounded-[28px]  px-5 py-6 shadow-[0_12px_30px_rgba(0,0,0,0.08)]  sm:px-8 sm:py-8 lg:gap-12 lg:bg-transparent lg:px-0 lg:py-0 lg:shadow-none lg:backdrop-blur-0">
              <div className="flex flex-col gap-5 sm:gap-7">
                <h1 className="max-w-[620px] text-[clamp(34px,8vw,64px)] font-medium leading-[1.12] text-[#2b2b2b] sm:leading-[1.18]">
                  Honor Your Loved One with a Lasting Memorial.
                </h1>
                <p className="max-w-[600px] text-[15px] leading-6 text-[#2b2b2b] sm:text-[16px] sm:leading-[1.5]">
                  Every life is a unique story that deserves to be remembered. A
                  dedicated memorial is more than a marker-it is a sacred space
                  for reflection and a permanent testament to a life beautifully
                  lived. Let us help you design a tribute as extraordinary as
